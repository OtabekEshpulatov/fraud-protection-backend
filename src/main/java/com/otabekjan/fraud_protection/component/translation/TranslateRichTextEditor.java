...
/**
 * Author: abdul
 * Since: 12/7/2024 12:41 PM
 */
public class TranslateRichTextEditor extends RichTextEditor {
    ...
    public TranslateRichTextEditor() {
        JmixButton button = AppBeans.get(UiComponents.class).create(JmixButton.class);
        button.addClassName("translate-editor-suffix");
